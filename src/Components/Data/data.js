    ...
    allProject: [
        {
            ...
            teckstack: ["React.js", "Tailwind CSS", "MUI"],
            status: 'LIVE',
            featured: true
        },
         {
            ...
            teckstack: ["React", "Tailwind CSS", "Redux Toolkit"],
            status: 'LIVE',
            featured: true
        },
        {
            ...
            teckstack: ["React", "Tailwind CSS", "Node.js", "Express.js", "MongoDB", "CLIP AI", "Machine Learning" ],
            status: 'LIVE',
            featured: true
        },
    ],
